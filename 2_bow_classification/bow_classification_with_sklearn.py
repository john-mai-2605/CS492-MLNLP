...
Original file is located at
    https://colab.research.google.com/drive/1oTSf35rJ-fZaqUwDDrqvnrTBUwbPkVrE
"""
...
def preprocess_and_split_to_tokens(sentences):
    ...
    tokens=[]
    special="!#$%&()*+,-./:;<=>?@[\]^_`{|}~]:\n\t\'\""
    suffixes=["es","er","s","ed","ing","ment","ful","tion","ity","ship","ness","al","ence","ent","ly","nt","able","or","est","ess","ish"]
    for sentence in sentences:
      #Preprocessing the whole sentence
      ...
      #Preprocessing the words in the sentence (remove unnecessary words)
      ...
      for word in token:
        ...
        for suffix in suffixes:
          if word.endswith(suffix):
            try:
              token.remove(word)
              token.append(word.replace(suffix,""))
            except ValueError:
              pass
      tokens.append(token)
    return tokens
