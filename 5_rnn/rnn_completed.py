...
Original file is located at
    https://colab.research.google.com/drive/1mgd6Sh1Y6THo6HuyOn_H8KZa48FrkENS
"""
...
def encode_text(sentences, vectorizer=None, max_len=None, msg_prefix="\n", verbose=True):
    ...
    for s in sentences:
        ...
        # encoded = list(map(lambda x: vocab[x]+1 if x in vocab.keys(), tokens))
        encoded=[]
        for word in tokens:
          if word in vocab.keys():
            encoded.append(vocab[word]+1)
